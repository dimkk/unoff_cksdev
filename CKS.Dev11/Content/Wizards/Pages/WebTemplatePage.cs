...
namespace CKS.Dev11.VisualStudio.SharePoint.Content.Wizards.Pages
{
    ...
    class WebTemplatePage : BaseWizardPage
    {
            ...
            : base(wizard)
        {
            ...
            InitializeComponent();
            base.LoadSettings();
            base.Headline = Resources.WebTemplatePage1_StepTitle;
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            //Set the label text
            lblIntroduction.Text = Resources.WebTemplatePage1_Introduction;
            lblRequired.Text = Resources.WebTemplatePage1_Required;
            lnkMSDNArticle.Text = Resources.WebTemplatePage1_MSDNLinkText;

            LinkLabel.Link link = new LinkLabel.Link();
            link.Description = Resources.WebTemplatePage1_MSDNLinkText;
            link.LinkData = Resources.WebTemplatePage1_MSDNLinkUrl;
            link.Enabled = true;
            link.Name = "lnkMSDN";
            lnkMSDNArticle.Links.Add(link);

            lblTitle.Text = Resources.WebTemplatePage1_Title;
            lblWebTemplate.Text = Resources.WebTemplatePage1_WebTemplate;
        }
        ...
        private void txtTitle_Validated(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                errMessages.SetError(txtTitle, Resources.WebTemplatePage1_Title_Error);
            }
        }
