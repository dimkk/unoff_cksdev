...
namespace CKS.Dev11.VisualStudio.SharePoint.Deployment.DeploymentSteps
{
    ...
    public class AttachToIISWorkerProcessesStep : IDeploymentStep
    {
        ...
        {
            stepInfo.Name = Resources.AttachToIISWorkerProcessesStep_Name;
            stepInfo.StatusBarMessage = Resources.AttachToIISWorkerProcessesStep_StatusBarMessage;
            stepInfo.Description = Resources.AttachToIISWorkerProcessesStep_Description;
        }
