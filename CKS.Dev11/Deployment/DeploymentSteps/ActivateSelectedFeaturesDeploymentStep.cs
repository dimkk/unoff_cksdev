...
namespace CKS.Dev11.VisualStudio.SharePoint.Deployment.DeploymentSteps
{
    ...
    public class ActivateSelectedFeaturesDeploymentStep : IDeploymentStep
    {
        ...
        {
            stepInfo.Name = Resources.ActivateSelectedFeaturesDeploymentStep_Name;
            stepInfo.StatusBarMessage = Resources.ActivateSelectedFeaturesDeploymentStep_StatusBarMessage;
            stepInfo.Description = Resources.ActivateSelectedFeaturesDeploymentStep_Description;
        }
