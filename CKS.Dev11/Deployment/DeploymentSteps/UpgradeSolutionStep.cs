...
namespace CKS.Dev11.VisualStudio.SharePoint.Deployment.DeploymentSteps
{
        ...
        : IDeploymentStep
    {
        ...
        {
            stepInfo.Name = Resources.UpgradeSolutionStep_Name;
            stepInfo.StatusBarMessage = Resources.UpgradeSolutionStep_StatusBarMessage;
            stepInfo.Description = Resources.UpgradeSolutionStep_Description;
        }
