...
namespace CKS.Dev11.VisualStudio.SharePoint.Deployment.DeploymentSteps
{
        ...
        : IDeploymentStep
    {
        ...
        {
            stepInfo.Name = Resources.WarmUpSiteStep_Name;
            stepInfo.StatusBarMessage = Resources.WarmUpSiteStep_StatusBarMessage;
            stepInfo.Description = Resources.WarmUpSiteStep_Description;
        }
