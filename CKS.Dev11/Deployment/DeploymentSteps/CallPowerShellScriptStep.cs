...
namespace CKS.Dev11.VisualStudio.SharePoint.Deployment.DeploymentSteps
{
        ...
        : IDeploymentStep
    {
        ...
        {
            stepInfo.Name = Resources.CallPowerShellScriptStep_Name;
            stepInfo.StatusBarMessage = Resources.CallPowerShellScriptStep_StatusBarMessage;
            stepInfo.Description = Resources.CallPowerShellScriptStep_Description;
        }
