...
using CKS.Dev12.VisualStudio.SharePoint.Deployment.QuickDeployment;
using CKS.Dev12.VisualStudio.SharePoint.Deployment;
#elif VS2014Build_SYMBOL
using CKS.Dev13.VisualStudio.SharePoint.Deployment.ProjectProperties;
using CKS.Dev13.VisualStudio.SharePoint.Deployment.QuickDeployment;
using CKS.Dev13.VisualStudio.SharePoint.Deployment;
#else
