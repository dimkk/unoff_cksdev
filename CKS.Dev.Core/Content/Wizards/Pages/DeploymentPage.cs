    ...
    namespace CKS.Dev11.VisualStudio.SharePoint.Content.Wizards.Pages
#elif VS2013Build_SYMBOL
namespace CKS.Dev12.VisualStudio.SharePoint.Content.Wizards.Pages
#elif VS2014Build_SYMBOL
    namespace CKS.Dev13.VisualStudio.SharePoint.Content.Wizards.Pages
#else
...
#endif
{
...
#if VS2012Build_SYMBOL
    using CKS.Dev11.VisualStudio.SharePoint.Content.Wizards;
    using CKS.Dev11.VisualStudio.SharePoint.Content.Wizards.Models;
    using CKS.Dev11.VisualStudio.SharePoint.Content.Wizards.Pages;
#elif VS2013Build_SYMBOL
    using CKS.Dev12.VisualStudio.SharePoint.Content.Wizards;
    using CKS.Dev12.VisualStudio.SharePoint.Content.Wizards.Models;
    using CKS.Dev12.VisualStudio.SharePoint.Content.Wizards.Pages;
#elif VS2014Build_SYMBOL
    using CKS.Dev13.VisualStudio.SharePoint.Content.Wizards;
    using CKS.Dev13.VisualStudio.SharePoint.Content.Wizards.Models;
    using CKS.Dev13.VisualStudio.SharePoint.Content.Wizards.Pages;
#else
    ...
    {
        #if VS2012Build_SYMBOL
        private CKS.Dev11.VisualStudio.SharePoint.Content.Wizards.Models.DeploymentPresentationModel _model;
        #elif VS2013Build_SYMBOL
        private CKS.Dev12.VisualStudio.SharePoint.Content.Wizards.Models.DeploymentPresentationModel _model;
        #elif VS2014Build_SYMBOL
        private CKS.Dev13.VisualStudio.SharePoint.Content.Wizards.Models.DeploymentPresentationModel _model;
        #else
        private CKS.Dev.VisualStudio.SharePoint.Content.Wizards.Models.DeploymentPresentationModel _model;
        #endif
