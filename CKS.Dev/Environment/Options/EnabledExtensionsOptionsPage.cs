...
namespace CKS.Dev.VisualStudio.SharePoint.Environment.Options
{
    ...
    public class EnabledExtensionsOptionsPage : DialogPage
    {
        ...
        private bool _GetFieldProperties = true;
        /// <summary>
        /// Gets or sets a value indicating whether [get field properties].
        /// </summary>
        /// <value><c>true</c> if [get field properties]; otherwise, <c>false</c>.</value>
        [Category("Exploration")]
        [DisplayName("Get Field Properties")]
        [DefaultValue(true)]
        public bool GetFieldProperties { get { return _GetFieldProperties; } set { _GetFieldProperties = value; } }
        #endregion
        #endregion
