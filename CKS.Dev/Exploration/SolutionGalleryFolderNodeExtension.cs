...
namespace CKS.Dev.VisualStudio.SharePoint.Exploration
{
    ...
    class SolutionGalleryFolderNodeExtension : IExplorerNodeTypeExtension
    {
        #region Methods
        ...
        void SolutionGallery_NodePropertiesRequested(object sender, ExplorerNodePropertiesRequestedEventArgs e)
        {
            ...
            if (e.Node.Text == Resources.SiteNodeExtension_SolutionGalleryNodeName)
            {
        ...
        void SolutionGallery_NodeMenuItemsRequested(object sender, ExplorerNodeMenuItemsRequestedEventArgs e)
        {
            ...
            if (e.Node.Text == Resources.SiteNodeExtension_SolutionGalleryNodeName)
            {
                ...
                e.MenuItems.Add(Resources.SolutionGalleryFolderNodeExtension_ViewInBrowser).Click += SolutionGalleryGenericFolderNodeExtension_Click;
            }
        }
