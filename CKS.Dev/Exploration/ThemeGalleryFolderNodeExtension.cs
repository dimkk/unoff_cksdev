...
namespace CKS.Dev.VisualStudio.SharePoint.Exploration
{
    ...
    class ThemeGalleryFolderNodeExtension : IExplorerNodeTypeExtension
    {
        #region Methods
        ...
        void ThemeGallery_NodePropertiesRequested(object sender, ExplorerNodePropertiesRequestedEventArgs e)
        {
            ...
            if (e.Node.Text == Resources.SiteNodeExtension_ThemeGalleryNodeName)
            {
        ...
        void ThemeGallery_NodeMenuItemsRequested(object sender, ExplorerNodeMenuItemsRequestedEventArgs e)
        {
            ...
            if (e.Node.Text == Resources.SiteNodeExtension_ThemeGalleryNodeName)
            {
                ...
                e.MenuItems.Add(Resources.ThemeGalleryFolderNodeExtension_ViewInBrowser).Click += ThemeGalleryGenericFolderNodeExtension_Click;
            }
        }
