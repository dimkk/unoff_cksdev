...
namespace CKS.Dev.VisualStudio.SharePoint.Exploration
{
    ...
    class WebPartGalleryFolderNodeExtension : IExplorerNodeTypeExtension
    {
        #region Methods
        ...
        void WebPartGallery_NodePropertiesRequested(object sender, ExplorerNodePropertiesRequestedEventArgs e)
        {
            ...
            if (e.Node.Text == Resources.SiteNodeExtension_WebPartGalleryNodeName)
            {
        ...
        void WebPartGallery_NodeMenuItemsRequested(object sender, ExplorerNodeMenuItemsRequestedEventArgs e)
        {
            ...
            if (e.Node.Text == Resources.SiteNodeExtension_WebPartGalleryNodeName)
            {
                ...
                e.MenuItems.Add(Resources.WebPartGalleryFolderNodeExtension_ViewInBrowser).Click += WebPartGalleryGenericFolderNodeExtension_Click;
            }
        }
