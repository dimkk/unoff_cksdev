    ...
    public class EntityClassesListNodeExtension : IExplorerNodeTypeExtension
    {
        ...
        void SPMetalListNodeExtension_Click(object sender, MenuItemEventArgs e)
        {
            ...
            if (projectService != null)
            {
                ...
                File.WriteAllText(tempParamsFilePath, String.Format(Properties.Resources.SPMetalListParametersXml, listInfo.Title));

                SPMetal.RunSPMetal(listNode.Context.SiteUrl.ToString(), String.Format(" /parameters:{0}", tempParamsFilePath), ProjectUtilities.GetSafeFileName(listInfo.Title) + ".cs", projectService);
