...
namespace CKS.Dev.VisualStudio.SharePoint.Deployment.DeploymentSteps
{
    ...
    public class AttachToSPUCWorkerProcessStep : IDeploymentStep
    {
        /// <summary>
        ...
        {
            stepInfo.Name = "Attach to User Code process (CKSDev)";
            stepInfo.StatusBarMessage = "Attaching to the User Code process...";
            stepInfo.Description = "Attachs the debugger to the User Code process.";
        }
        ...
        public void Execute(IDeploymentContext context)
        {
            ...
            utils.AttachToProcessByName(project, ProcessConstants.SPUCWorkerProcess);
        }
    }
}
