...
namespace CKS.Dev.VisualStudio.SharePoint.Deployment.DeploymentSteps
{
    ...
    public class AttachToVSSPHost4ProcessStep : IDeploymentStep
    {
        /// <summary>
        ...
        {
            stepInfo.Name = "Attach to VSS4 Host process (CKSDev)";
            stepInfo.StatusBarMessage = "Attaching to the VSS4 Host process...";
            stepInfo.Description = "Attachs the debugger to the VSS4 Host process.";
        }
        ...
        public void Execute(IDeploymentContext context)
        {
            ...
            utils.AttachToProcessByName(project, ProcessConstants.VSSHost4Process);
        }
    }
}
