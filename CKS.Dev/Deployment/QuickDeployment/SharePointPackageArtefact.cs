    ...
    public class SharePointPackageArtefact : QuickCopyableSharePointArtefact
    {
        ...
        public string BasePackagePath
        {
            get
            {
                ...
                sourcePathBase = Path.Combine(sourcePathBase, projectManager.DteProject.ConfigurationManager.ActiveConfiguration.ConfigurationName);
        ...
        public string AssemblyPath
        {
            get
            {
                ...
                return Path.Combine("bin\\", projectManager.DteProject.ConfigurationManager.ActiveConfiguration.ConfigurationName);
            }
        }
        ...
        public override Dictionary<string, string> Tokens
        {
            ...
            {
                ProjectManager projectManager = new ProjectManager(project);
                EnvDTE.Project dteProject = projectManager.DteProject;
                if (tokens == null)
                {
                    ...
                    tokens.Add("SharePoint.Project.AssemblyPublicKeyToken", assemblyName == null ? "PROJECTNOTBUILT" : QuickDeploymentUtilities.GetPublicKeyToken(assemblyName.FullName));
                    
                    //Get the Guid based replaceable params
                    Dictionary<string, string> guidTokens = QuickDeploymentUtilities.GetReplaceableGuidTokens(project, true);
            ...
            if (project.IncludeAssemblyInPackage)
            {
                ...
                if (requiresQuickPackage)
                {
                    ...
                    if (File.Exists(project.OutputFullPath))
                    {
                        ...
                        QuickDeploymentUtilities.CopyFileWithTokenReplacement(this.Project,
                            assemblyName,
                ...
                {
                    QuickDeploymentUtilities.CopyToGac(project, sourceAssembly);
                }
                else
                {
                    QuickDeploymentUtilities.CopyToBin(project, sourceAssembly);
                }
            }
