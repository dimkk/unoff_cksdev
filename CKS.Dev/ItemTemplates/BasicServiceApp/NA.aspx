<%@ Page Language="C#" Inherits="$rootnamespace$.New$subnamespace$ApplicationPage, $SharePoint.Project.AssemblyFullName$" MasterPageFile="~/_layouts/dialog.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="PlaceHolderDialogBodyMainSection" runat="server">
    <table border="0" cellpadding="0" cellspacing="0">
        <wssuc:InputFormSection runat="server"
            Title="Name"
            Description="Provide a unique name for this $fileinputname$ Application.">
