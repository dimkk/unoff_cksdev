...
namespace CKS.Dev.VisualStudio.SharePoint.Content
{
    ...
    [SharePointProjectItemIcon("CKS.Dev.VisualStudio.SharePoint.Resources.SolutionExplorerIcons.SPMetalDefinition_SolutionExplorer.ico")]
    class SPMetalDefinitionTypeProvider : ISharePointProjectItemTypeProvider
    {
        ...
        public void InitializeType(ISharePointProjectItemTypeDefinition typeDefinition)
        {
            ...
            typeDefinition.Name = "SPMetalDefinition";
        ...
        internal void ForceRegenerate(ISharePointProjectItem owner, SPMetalDefinitionProperties properties)
        {
            ...
            ProjectItemManager itemManager = new ProjectItemManager(owner);

            ProjectItem dteItem = owner.Project.ProjectService.Convert<ISharePointProjectItemFile, ProjectItem>(itemManager.Item.DefaultFile);
