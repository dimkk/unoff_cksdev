...
namespace CKS.Dev.VisualStudio.SharePoint.Content.Wizards.Pages
{
    ...
    /// </summary>
    class HideCustomActionPage : BaseWizardPage
    {
        #region Controls
        ...
        /// </summary>
        protected HideCustomActionPresentationModel CurrentModel
        {
            get;
            set;
        }
        ...
        /// <param name="model">The HideCustomActionPresentationModel object</param>
        public HideCustomActionPage(ArtifactWizardForm wizard, HideCustomActionPresentationModel model)
            : base(wizard)
        {
            CurrentModel = model;
            InitializeComponent();
            base.LoadSettings();
            base.Headline = Resources.HideCustomActionPage_StepTitle;
            base.HelpKeyword = "VS.SharePointTools.SPE.HideCustomAction";
        }
        ...
        protected override void OnLoad(EventArgs e)
        {
            ...
            //Set the label text
            lblIntroduction.Text = Resources.HideCustomActionPage_Introduction;
            lblRequired.Text = Resources.HideCustomActionPage_Required;
            lnkMSDNArticle.Text = Resources.HideCustomActionPage_MSDNLinkText;

            System.Windows.Forms.LinkLabel.Link link = new System.Windows.Forms.LinkLabel.Link();
            link.Description = Resources.HideCustomActionPage_MSDNLinkText;
            link.LinkData = Resources.HideCustomActionPage_MSDNLinkUrl;
            link.Enabled = true;
            link.Name = "lnkMSDN";
            lnkMSDNArticle.Links.Add(link);

            lblId.Text = Resources.HideCustomActionPage_ID;
            lblGroupId.Text = Resources.HideCustomActionPage_GroupId;
            lblHideActionId.Text = Resources.HideCustomActionPage_HideActionId;
            lblLocation.Text = Resources.HideCustomActionPage_Location;
            btnGenerateGuid.Text = Resources.HideCustomActionPage_GenerateGuid;
        }
        ...
        private void InitializeComponent()
        {
            ...
            this.txtHideActionId.TabIndex = 3;
            // 
            // lblLocation
            // 
            ...
            // 
            // HideCustomActionPage
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
            this.BackColor = System.Drawing.SystemColors.Control;
            this.Controls.Add(this.tableLayoutPanel1);
            this.Name = "HideCustomActionPage";
