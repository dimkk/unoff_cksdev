...
{
    /// <summary>
    /// The SandBox Visual Web Part properties
    /// </summary>
    class SandBoxedVisualWebPartProperties : INotifyPropertyChanged
    {
        #region Fields
        ...
        /// <summary>
        /// Initialise a new SandBoxVisualWebPartProperties
        /// </summary>
        public SandBoxedVisualWebPartProperties()
        {
        ...
        public SandBoxedVisualWebPartProperties(Guid uniqueId, ISourceUrlSource urlSource)
        {
