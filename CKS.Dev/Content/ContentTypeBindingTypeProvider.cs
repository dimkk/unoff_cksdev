...
namespace CKS.Dev.VisualStudio.SharePoint.Content
{
    ...
    [SharePointProjectItemIcon("CKS.Dev.VisualStudio.SharePoint.Resources.SolutionExplorerIcons.ContentTypeBinding_SolutionExplorer.ico")]
    partial class ContentTypeBindingTypeProvider : ISharePointProjectItemTypeProvider
    {
        ...
        {
            typeDefinition.Name = "ContentTypeBinding";
